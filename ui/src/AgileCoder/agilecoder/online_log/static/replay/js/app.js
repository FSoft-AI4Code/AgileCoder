...
function watchfileInput(content, _folder_name) {
    // console.log(content);
    if (content.length > 0) {
        contents = content;
...
function createPara(d, i) {
    ...
    if (d.type && d.character) {
        ...
        if (d.character == "Programmer") {
            ...
            characterimg.src = "static/figures/reviewer.png";
        } else if (d.character == "Chief Human Resource Officer") {
            characterimg.src = "static/figures/hr.png";
        } else if (d.character == "Chief Executive Officer") {
            characterimg.src = "static/figures/ceo.png";
        } else if (d.character == "Chief Product Officer") {
            characterimg.src = "static/figures/cpo.png";
        } else if (d.character == "Chief Technology Officer") {
            characterimg.src = "static/figures/cto.png";
        } else if (d.character == "Chief Creative Officer") {
            characterimg.src = "static/figures/designer.png";
        } else if (d.character == "Software Test Engineer") {
            characterimg.src = "static/figures/tester.png";
        } else if (d.character == "User") {
            characterimg.src = "static/figures/user.png";
